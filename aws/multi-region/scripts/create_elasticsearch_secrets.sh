...
create_namespace "$CLUSTER_1" "$CAMUNDA_NAMESPACE_2"
...
create_secret "$CLUSTER_2" "$CAMUNDA_NAMESPACE_2" "elasticsearch-env-secret" "$AWS_ACCESS_KEY_ES" "$AWS_SECRET_ACCESS_KEY_ES"
