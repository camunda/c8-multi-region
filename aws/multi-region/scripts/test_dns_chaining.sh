...
create_namespace "$CLUSTER_2" "$CAMUNDA_NAMESPACE_2"
...
kubectl --context "$CLUSTER_2" apply -f https://raw.githubusercontent.com/camunda/c8-multi-region/main/aws/dual-region/kubernetes/nginx.yml -n "$CAMUNDA_NAMESPACE_2"
...
kubectl --context "$CLUSTER_2" wait --for=condition=Ready pod/sample-nginx -n "$CAMUNDA_NAMESPACE_2" --timeout=300s

ping_instance "$CLUSTER_0" "$CAMUNDA_NAMESPACE_0" "$CAMUNDA_NAMESPACE_1"
ping_instance "$CLUSTER_0" "$CAMUNDA_NAMESPACE_0" "$CAMUNDA_NAMESPACE_2"
ping_instance "$CLUSTER_1" "$CAMUNDA_NAMESPACE_1" "$CAMUNDA_NAMESPACE_0"
ping_instance "$CLUSTER_1" "$CAMUNDA_NAMESPACE_1" "$CAMUNDA_NAMESPACE_2"
ping_instance "$CLUSTER_2" "$CAMUNDA_NAMESPACE_2" "$CAMUNDA_NAMESPACE_0"
ping_instance "$CLUSTER_2" "$CAMUNDA_NAMESPACE_2" "$CAMUNDA_NAMESPACE_1"
...
kubectl --context "$CLUSTER_2" delete -f https://raw.githubusercontent.com/camunda/c8-multi-region/main/aws/dual-region/kubernetes/nginx.yml -n "$CAMUNDA_NAMESPACE_2"
